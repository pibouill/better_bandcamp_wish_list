...
<svelte:head>
  <title>{username}'s Wishlist | Bandcamp Wishlist Viewer</title>
</svelte:head>
  ...
  <footer class="mt-auto py-6 border-t">
    <div class="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-500">
      ...
      <div class="flex gap-4">
        ...
        <a href="https://github.com/pibouill/better_bandcamp_wishlist" target="_blank" class="hover:text-gray-700 flex items-center gap-1">
