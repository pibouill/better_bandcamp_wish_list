...
<svelte:head>
  <title>Bandcamp Wishlist Viewer</title>
</svelte:head>
...
<div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
  <div class="max-w-md w-full">
    <div class="text-center mb-8">
      ...
      <h1 class="text-3xl font-bold text-white mb-2">Bandcamp Wishlist Viewer</h1>
    ...
    <div class="flex justify-center gap-4 mt-4 text-sm">
      ...
      <a href="https://github.com/pibouill/better_bandcamp_wishlist" target="_blank" class="text-gray-500 hover:text-gray-400 flex items-center gap-1">
